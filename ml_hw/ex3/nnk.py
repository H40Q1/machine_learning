...
# 1.3.2 prediction
prob_matrix = sigmoid(X @ k_theta.T)  # X(5000,401) k_theta(10,401), prob_matrix (5000,10)
# 5000 example with 10 predictions on each types, pick the largest one as final predict
y_pred = np.argmax(prob_matrix, axis=1)  # return the index of max value on axis, axis=1 means row (5000,)
raw_X, raw_y = load_data('ex3data1.mat')
y_answer = raw_y.copy()
y_answer[y_answer == 10] = 0  # y_answer is equal to raw_y except the 10 changes to 0  (5000,)
